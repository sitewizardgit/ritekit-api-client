...
<html>
    <head>
        ...
        <script src="www/js/global.js"></script>
    ...
    <body>
        <div class="page">
            <h1>Infobar via Ritetag rest API</h1>

            
            <div style="margin:15px;width: 500px;height: 200px" class="tweet-content">
            <div style="padding-left: 15px" class="ritetag-infobar"></div>
            <div style="width:100%;height: 100%;border: #292f33 1px solid" class="tweet-box rich-editor" contenteditable="true"></div>
            </div>
