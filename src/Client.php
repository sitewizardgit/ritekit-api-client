<?php
    ...
    class Client {
        ...
        private $host = "https://api.ritekit.com/";
        ...
        function accessTokenURL() {
            return 'https://ritekit.com/oauth/access_token';
        }

        function authorizeURL() {
            return 'https://ritekit.com/oauth/authorize';
        }

        function requestTokenURL() {
            return 'https://ritekit.com/oauth/request_token';
        }

        function receiveTokenURL() {
            return 'https://ritekit.com/oauth/token';
        }
        ...
        public function getAuthroizeToken() {

            $parameters = OAuthUtil::build_http_query(array(
                'response_type' => 'code',
                'client_id'     => $this->consumer->key,
                'redirect_uri'  => 'http://ritekit/example.php',
                'scope'         => 'data'
            ));

            $url = $this->authorizeURL() . '?' .$parameters;
            return $url;
        }

        public function getReceiveToken($code)
        {
            $parameters = array(
            ...
            return $this->http($this->receiveTokenURL(), 'POST', $parameters);
        }
        ...
        public function trendingHashtags($green = false, $latin = false) {
            return $this->get("/v1/stats/trending/", ['green'=>$green,'latin'=>$latin]);
        }
        ...
        public function influencersForHashtag($hashtag) {
            return $this->get("/v1/stats/influencers/" . urlencode($hashtag));
        }
        ...
        public function historicalData($hashtag) {
            return $this->get("/v1/stats/history/" . urlencode($hashtag));
        }
        /**
         *
         * @param string $tweet
        ...
        public function curlSettings($curl){
